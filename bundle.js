...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherClock = __webpack_require__(159);
	var Autocomplete = __webpack_require__(160);
	...
	var myTabs = [{ id: 1, title: "Here's the WeatherClock!", content: React.createElement(WeatherClock, null) }, { id: 2, title: "hi again", content: "bye again" }, { id: 3, title: "and Nick Cage", content: React.createElement('img', { src: 'http://ia.media-imdb.com/images/M/MV5BMTUzMDM4Nzk2MV5BMl5BanBnXkFtZTcwNTcwNjExOQ@@._V1_UY1200_CR96,0,630,1200_AL_.jpg' }) }, { id: 4, title: "Autocomplete", content: React.createElement(Autocomplete, { libraries: libraries }) }];
	
	ReactDOM.render(React.createElement(Tabs, { tabs: myTabs }), document.getElementById('menu'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherClock = React.createClass({
	  ...
	  setCurrentWeather: function () {
	    ...
	    var myurl = "http://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + long + "&appid=645c5d39c7603f17e23fcaffcea1a3c1";
	    ...
	    $.ajax({
	      ...
	      success: function (data) {
	        console.log("yeah!");
	        self.setState({ weather: [data.main.temp, data.weather[0].description, data.name] });
	      },
	      error: function () {
